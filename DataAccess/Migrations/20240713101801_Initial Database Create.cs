        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerGuid = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScrumRole = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetingLeaderGuid = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MeetingGuid = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AttachmentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MeetingAttachments", x => new { x.MeetingGuid, x.AttachmentId })
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.MeetingGuid,
                        principalTable: "Meetings",
                        principalColumn: "Guid");
                });

            migrationBuilder.CreateTable(
                name: "TeammateMeetings",
                columns: table => new
                {
                    TeammateGuid = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MeetingGuid = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeammateMeetings", x => new { x.TeammateGuid, x.MeetingGuid })
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
