...
public class ModelConverterTests
{
    ...
    {
        var actual = ModelConverter.ConvertProjectModelToRecord(input);
    ...
    {
        var actual = ModelConverter.ConvertProjectRecordToModel(input);
    ...
    {
        var actual = ModelConverter.ConvertFeatureModelToRecord(input);
    ...
    {
        var actual = ModelConverter.ConvertFeatureRecordToModel(input);
    ...
    {
        var actual = ModelConverter.ConvertTaskModelToRecord(input);
    ...
    {
        var actual = ModelConverter.ConvertTaskRecordToModel(input);
