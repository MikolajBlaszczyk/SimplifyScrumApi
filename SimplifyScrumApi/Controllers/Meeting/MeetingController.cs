...
public class MeetingController(ISchedule scheduler, IManageMeetings meetingsManager, ResultUnWrapper unWrapper) : ControllerBase
{
    ...
    { 
        var meetingAddResult = await meetingsManager.UpsertMeeting(record);
