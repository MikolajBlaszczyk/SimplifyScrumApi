...
public class CalendarArranger
{
    ...
    public List<Day> PrepareDaysWithMeetings(DateTime date, IList<IGrouping<int, MeetingRecord>> groupedMeetings)
    {
        List<Day> days = new();
        ...
        for (int day = 1; day <= numberOfDays; day++)
        {
            ...
            Day currentDay = new(dayFullDate, currenDayMeetings);
